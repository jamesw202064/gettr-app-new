...
export const Icon = ({ data, parentColor = '', className = '', tinaField = '' }) => {
  ...
  const iconSizeClasses =
    typeof size === 'string' ? iconSizeClass[size] : iconSizeClass[Object.keys(iconSizeClass)[size]];
  ...
  if (style == 'circle') {
    ...
    return <IconSVG data-tinafield={tinaField} className={`${iconSizeClasses} ${iconColorClasses} ${className}`} />;
  }
};
